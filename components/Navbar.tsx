        ...
        <div className="flex justify-between items-center h-24">
          ...
          <div className="md:hidden flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 flex items-center justify-center hover:scale-110 text-white transition-all cursor-pointer border border-white/20 shadow-lg"
              title="Follow us on Instagram"
            >
            ...
            <a href="tel:7142679974" className="bg-blue-600 text-white p-3 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg">
              {ICON_MAP.PhoneCall}
            </a>
          </div>
        </div>
